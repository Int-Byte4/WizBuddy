...
public enum StatusEnum {
    ...
    BUSINESS_NUM_DUPLICATE(400, HttpStatus.BAD_REQUEST, "이미 등록된 사업자등록번호입니다."),
    ...
    SHOP_NOT_FOUND(404, HttpStatus.NOT_FOUND, "존재하지 않는 매장입니다."),
    USER_NOT_IN_SHOP(404, HttpStatus.NOT_FOUND, "매장에 존재하지 않는 직원입니다."),
