...
//                                .requestMatchers(new AntPathRequestMatcher("/users/employees/", "GET")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employers/", "GET")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employer/", "GET")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employee/", "GET")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employer/edit", "PATCH")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employer/delete", "PATCH")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employee/edit", "PATCH")).permitAll()
//                                .requestMatchers(new AntPathRequestMatcher("/users/employee/delete", "PATCH")).permitAll()
...
//                                .requestMatchers(new AntPathRequestMatcher("/manualboards/like", "POST")).hasRole("EMPLOYEE")
//                                .requestMatchers(new AntPathRequestMatcher("/noticeboards/like", "POST")).hasRole("EMPLOYEE")
